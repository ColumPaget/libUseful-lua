...
stream.so: stream_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o stream.so stream_wrap.o $(LIBS)
...
terminal.so: terminal_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o terminal.so terminal_wrap.o $(LIBS)
...
filesys.so: filesys_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o filesys.so filesys_wrap.o $(LIBS)
...
process.so: process_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o process.so process_wrap.o $(LIBS)
...
net.so: net_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o net.so net_wrap.o $(LIBS)
...
syslog.so: syslog_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o syslog.so syslog_wrap.o $(LIBS)
...
hash.so: hash_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o hash.so hash_wrap.o $(LIBS)
...
sys.so: sys_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o sys.so sys_wrap.o $(LIBS)
...
time.so: time_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o time.so time_wrap.o $(LIBS)
...
strutil.so: strutil_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o strutil.so strutil_wrap.o $(LIBS)
...
dataparser.so: dataparser_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o dataparser.so dataparser_wrap.o $(LIBS)
...
oauth.so: oauth_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o oauth.so oauth_wrap.o $(LIBS)
...
rawdata.so: rawdata_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o rawdata.so rawdata_wrap.o $(LIBS)
...
securemem.so: securemem_wrap.o
	$(CC) $(CFLAGS) $(SHLIB_FLAGS) -o securemem.so securemem_wrap.o $(LIBS)
